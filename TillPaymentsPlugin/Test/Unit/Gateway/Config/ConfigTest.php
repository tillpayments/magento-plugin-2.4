...
namespace TillPayments\TillPaymentsPlugin\Test\Unit\Gateway\Config;

use Magento\Framework\App\Config\ScopeConfigInterface;
use Magento\Framework\Serialize\Serializer\Json;
use Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use Magento\Store\Model\ScopeInterface;
use TillPayments\TillPaymentsPlugin\Gateway\Config\Config;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;

class ConfigTest extends TestCase
{
    const METHOD_CODE = 'tillpayments';
    ...
    /**
     * @covers       \TillPayments\TillPaymentsPlugin\Gateway\Config\Config::getCountryAvailableCardTypes
     * @dataProvider getCountrySpecificCardTypeConfigDataProvider
    ...
    /**
     * @covers \TillPayments\TillPaymentsPlugin\Gateway\Config\Config::isCvvEnabled
     */
