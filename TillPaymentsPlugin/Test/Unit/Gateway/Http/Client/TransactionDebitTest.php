...
use TillPayments\TillPaymentsPlugin\Gateway\Http\Client\TransactionDebit;
...
{
    /**
     * @var TransactionDebit
     */
    private TransactionDebit $debitModel;
    ...
    public function testPlaceRequestSuccess()
    {
        ...
        $actualResult = $this->debitModel->placeRequest($this->getTransferObjectMock());
    ...
    private function getTransferObjectMock()
    {
        ...
        $transferObjectMock->expects($this->once())->method('getBody')->willReturn($this->getTransferData());
    ...
    protected function setUp(): void
    {
        ...
        $this->debitModel = new TransactionDebit($this->loggerMock,$this->serviceMock);
    }
}
