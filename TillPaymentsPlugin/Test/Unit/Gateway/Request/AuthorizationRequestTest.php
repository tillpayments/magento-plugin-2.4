...
use TillPayments\TillPaymentsPlugin\Gateway\Request\AuthorizationRequest;
...
class AuthorizationRequestTest extends TestCase
{
    ...
    /**
     * @covers \TillPayments\TillPaymentsPlugin\Gateway\Request\AuthorizationRequest::build
     */
