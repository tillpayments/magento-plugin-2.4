        ...
        return Component.extend({
            ...
            placeOrder: async function (data, event) {
                if (this.isSeamless()) {
                    ...
                    var form = $('#tillpayments_form_' + this.getCode());
                    ...
                    try {
                        ...
                        error.forEach(message => {
                            validator.showLabel($('#tillpayments_cc_' + message.attribute + '_' + this.getCode()).get(0), message.message);
                        });
            ...
            afterPlaceOrder: function () {
                if ((this.isThreeDSecure() === 'OPTIONAL') || (this.isThreeDSecure() === 'MANDATORY')) {
                    ...
                    $.ajax({
                        url: url.build('tillpayments/payment/frontend'),
                        type: 'post',
                        success: (result) => {
                            console.log(result);
